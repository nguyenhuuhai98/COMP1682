                            ...
                            <div class="card m-b-20">
                                <div class="card-body">
                                    ...
                                    <div class="inbox-wid">
                                        ...
                                        <a href="#" class="text-dark">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img float-left mr-3"><img src="images/users/user-2.jpg" class="thumb-md rounded-circle" alt=""></div>
                                        ...
                                        <a href="#" class="text-dark">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img float-left mr-3"><img src="images/users/user-3.jpg" class="thumb-md rounded-circle" alt=""></div>
                                        ...
                                        <a href="#" class="text-dark">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img float-left mr-3"><img src="images/users/user-4.jpg" class="thumb-md rounded-circle" alt=""></div>
                                        ...
                                        <a href="#" class="text-dark">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img float-left mr-3"><img src="images/users/user-5.jpg" class="thumb-md rounded-circle" alt=""></div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <img src="images/users/user-2.jpg" alt="" class="thumb-md rounded-circle mr-2"> Jeanette James
                                                    </div>
                                                </td>
                                                <td>14/8/2018</td>
                                                <td>$104</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <img src="images/users/user-3.jpg" alt="" class="thumb-md rounded-circle mr-2"> Christopher Taylor
                                                    </div>
                                                </td>
                                                <td>15/8/2018</td>
                                                <td>$112</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <img src="images/users/user-4.jpg" alt="" class="thumb-md rounded-circle mr-2"> Edward Vazquez
                                                    </div>
                                                </td>
                                                <td>15/8/2018</td>
                                                <td>$116</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <img src="images/users/user-5.jpg" alt="" class="thumb-md rounded-circle mr-2"> Michael Flannery
                                                    </div>
                                                </td>
                                                <td>16/8/2018</td>
                                                <td>$109</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <img src="images/users/user-6.jpg" alt="" class="thumb-md rounded-circle mr-2"> Jamie Fishbourne
                                                    </div>
                                                </td>
                                                <td>17/8/2018</td>
                                                <td>$120</td>
                                    ...
                                    <div class="table-responsive order-table">
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <img src="images/users/user-4.jpg" alt="" class="thumb-md rounded-circle mr-2"> Matthew Drapeau
                                                    </div>
                                                </td>
                                                <td>17/8/2018
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <img src="images/users/user-5.jpg" alt="" class="thumb-md rounded-circle mr-2"> Ralph Shockey
                                                    </div>
                                                </td>
                                                <td>18/8/2018
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <img src="images/users/user-6.jpg" alt="" class="thumb-md rounded-circle mr-2"> Alexander Pierson
                                                    </div>
                                                </td>
                                                <td>18//8/2018
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <img src="images/users/user-7.jpg" alt="" class="thumb-md rounded-circle mr-2"> Robert Rankin
                                                    </div>
                                                </td>
                                                <td>19/8/2018
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <img src="images/users/user-8.jpg" alt="" class="thumb-md rounded-circle mr-2"> Myrna Shields
                                                    </div>
                                                </td>
                                                <td>20/8/2018
